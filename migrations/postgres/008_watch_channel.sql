...
ALTER TABLE accumulation_watch ADD COLUMN IF NOT EXISTS channel TEXT DEFAULT 'coiling';
ALTER TABLE accumulation_watch ADD COLUMN IF NOT EXISTS channel_score DOUBLE PRECISION DEFAULT 0;
ALTER TABLE accumulation_watch ADD COLUMN IF NOT EXISTS metrics_json TEXT DEFAULT '{}';
