...
ALTER TABLE micro_scalp_alerts ADD COLUMN IF NOT EXISTS method TEXT DEFAULT '';
ALTER TABLE micro_scalp_alerts ADD COLUMN IF NOT EXISTS trade_size_usdt DOUBLE PRECISION DEFAULT 0;
